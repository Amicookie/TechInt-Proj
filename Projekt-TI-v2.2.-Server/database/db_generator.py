...
def insert_data():
    ...
    files = [
        ...
        {'file_name': 'File3',
         ...
         'file_creation_date': _get_date(), 'file_update_date': _get_date(), 'file_creator_id': 1,
         'file_last_editor_id': 1},
        {'file_name': 'KreatywnyPlik',
         'file_content': 'Jestem bardzo kreatywnym plikiem, czcijcie mnie! Bo jestem zmieniony! I juz nie',
         'file_creation_date': _get_date(), 'file_update_date': _get_date(), 'file_creator_id': 1,
         'file_last_editor_id': 1},
        {'file_name': 'InspirujacyPlik',
         'file_content': 'Jestem bardzo inspirujacym plikiem i kocham byc inspirujacy! Quote: Ja inspiruje -Plik.',
         'file_creation_date': _get_date(), 'file_update_date': _get_date(), 'file_creator_id': 1,
         'file_last_editor_id': 1}
    ]
